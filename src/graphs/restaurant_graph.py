"""Restaurant agent graph — stub.

Minimal triage → faq_response pipeline. Domain-specific nodes (reservations,
menu, orders) will be added as the restaurant agent is fleshed out.
"""
