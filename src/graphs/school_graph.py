"""School agent graph — stub.

Minimal triage → faq_response pipeline. Domain-specific nodes (enrollment,
scheduling, grades) will be added as the school agent is fleshed out.
"""
